...
CONSUMER_KEY = 'UkgKxy62NkH9Oe7ORhBZHdCuR'
CONSUMER_SECRET = 'i77yl6cxFC5v9y4Z8gnKVSDUBJ3Lmt97I9crUXUwZ7WwlFhoVJ'
OAUTH_TOKEN = '950857906760572928-2AcLnbJnFBs8z1HVGP35aT9xD4ITAKo'
OAUTH_TOKEN_SECRET = 'vJ0qvxgNFi7X1lmHvtK8nYh0LdGj3htdEnFoYy9r1N1if'
...
while(runCount != numTimesToRun):
    ...
    file3 = open('run' + str(runCount) + 'Percentages.txt', 'w+')
        ...
        for searchGroup, values in searchParams['searchGroups'].items():
            ...
            for tweet in stream:
                ...
                if(count == numOfTweets):
                    ...
                    file3.write("Percentage of positive tweets about "+searchGroup +' : '+str(posPercent)+"\n")
                    file3.write("Negative tweet percentage: "+str(negPercent)+"\n")
                    file3.write("pos: "+str(posCount)+", neg: "+str(negCount)+", neut: "+str(neutral)+"\n\n")
